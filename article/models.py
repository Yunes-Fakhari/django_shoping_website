...
class ArticleCategory(models.Model):
    parent = models.ForeignKey ('ArticleCategory' , null = True, blank = True, on_delete = models.CASCADE , verbose_name = '  دسته بندی زیر شاخه ' )
...
class Article(models.Model):
    ...
    short_description = RichTextField(verbose_name='توضیحات کوتاه')  # تغییر یافته
    text = RichTextField(null=True, verbose_name='متن مقاله')  # تغییر یافته
    ...
    dislikes = models.IntegerField(default=0, verbose_name='تعداد دیسلایک‌ها')
