...
@permission_checker_decorator_factory_for_admin({'permission_name': 'admin_index'})
def index(request: HttpRequest):
    return render(request, 'admin_panel/home/index.html')

@method_decorator(permission_checker_decorator_factory_for_admin({'permission_name': 'article_list'}), name='dispatch')
