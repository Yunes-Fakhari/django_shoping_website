...
class SiteSetting(models.Model):
    ...
    email = models.CharField(max_length = 200 , blank = True , null = True , verbose_name = 'ایمیل ')
...
class SiteBanner(models.Model):
    ...
    # position = models.CharField(max_length = 200 , choices =Site_Banner_Position verbose_name='جایگاه نمایش' )
